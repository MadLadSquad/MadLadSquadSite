...
The 1.0 release has been in development for about 2.5 years now, and this begs the question: what's next for the framework?
...
1. Release 1.1 - Native OS menu integration adapter. This adapter allows you to integrate your application with the OS menu. This is useful on macOS, where their desktop uses a global menu. This adapter will allow you to select your drawing method - OS or dear imgui
1. Release 1.2 and 1.3 - Window backend change, Android, iOS and iPadOS support
1. Release 1.3.5 - C API for implot
1. Release 1.4 - IME support in dear imgui, including mobile keyboards and selecting for both native and WASM targets
