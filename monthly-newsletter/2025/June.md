...
1. Create an adapter that allows applications to render the same title bar with dear imgui or with the native OS menu API. This
...
Metal, DirectX11 and DirectX12 APIs, as well as providing an API-agnostic renderer utilising the popular [bgfx](https://github.com/bkaradzic/bgfx) renderer library.
