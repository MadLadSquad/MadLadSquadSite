...
Work on release 0.9.9.0 has started. Its headline feature is the 1.0 release of the completely finished Vulkan and WebGPU renderers,
...
and all applications written on top of it have been packaged for Gentoo and Funtoo Linux under the
...
## Tiny.lol
We're finally starting work on <https://tiny.lol> again after more than 7 months of inactivity. Work has started on both the frontend and backend.

## Youyin
Plans for restarting work on the Youyin backend are starting to be drawn up.
