...
For users of version v1.X.X.X, check [this update guide](https://github.com/MadLadSquad/UntitledGameSystemManager/wiki/Upgrading-from-1.X.X.X-to-2.X.X.X) for version 2.
...
\* Other data was gathered through other sources, mainly: [hanzi-writer-data-jp](https://github.com/chanind/hanzi-writer-data-jp),
...
generate handwriting data for all writing systems, we hit a roadblock: the editor doesn't have the ability to work well with simple
