...
The need for creating this project is that [dear imgui](https://github.com/ocornut/imgui) doesn't have a native localisation
system. This is expected, as it is only a library. For our framework and toolkit, however, it's unacceptable not to have one.
...
Finally, imgui IME support is, unfortunately, lacking outside of Windows. This is because the underlying
