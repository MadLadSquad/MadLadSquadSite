...
## Version
The current version is 0.9.0.0
...
1. The `val` key sets the keys that need to be activated for the binding to be in the `pressed` or `repeat` state. This is an array
