...
1. The create project script can now elevate its privileges to administrator
...
1. New, updated & working UntitledOpen implementation (not fully operational on Linux)
