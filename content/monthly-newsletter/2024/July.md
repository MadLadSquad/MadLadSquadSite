...
Among the major improvements to the build system is that `CMakeLists.txt` breakages no longer happen, due to us moving 95% of all CMake code
...
With the 0.9.4.0 release of the [UntitledImGuiFramework](https://github.com/MadLadSquad/UntitledImGuiFramework), we can now
target WASM. We took advantage of that and made a demo site for the framework; you can check it out at <https://uimgui.madladsquad.com>,
...
The 1.0 release of the [UntitledDBusUtils](https://github.com/MadLadSquad/UntitledDBusUtils) library adds type-safe and generally
memory-safe interfaces for parsing message replies and DBus method calls.
...
to it, it's automatically type-safe and, in the vast majority of cases, memory-safe by default.
