...
1. MadLadSquad takes ownership over all current and future open-source projects
1. MadLadSquad takes ownership over all current and future forks of open-source projects
...
The split was mainly needed for administrative reasons; it does not really affect most of our current projects. The funding amount for MadLadSquad
...
1. Release 1.0.0.0:
   ...
   - Fixing plugin support on Windows and applying the custom allocators correctly
...
pkggen implements plugins, generators and templating in a similar way, but instead of using them to just generate ebuilds, users can generate
