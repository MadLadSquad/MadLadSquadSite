...
Our plan is to release these 4 versions of the UntitledImGuiFramework in January. Due to the way some changes are related to other changes
in this broader release bundle, there may be fewer point releases than the ones listed here.
...
Previously, users had to define custom macros and rewrite functions just to be able to use their own custom container
